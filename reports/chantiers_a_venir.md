...
**Prochain test, sans entraînement.** Comparer la variabilité des variations d'un jour de la PRODUCTION de la colonne, avant tout routage, à celle du débit observé. Si la production est déjà lissée à 0,54, le canal est hors de cause et le défaut est dans la colonne ou la réponse du versant ; si elle est à 1,0, tout se perd entre la colonne et l'exutoire.
