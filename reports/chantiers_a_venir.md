...
La classe de drainage est celle du sol naturel, pas la présence de drains souterrains, posés surtout dans les sols mal drainés. Le drainage artificiel, les bassins de rétention et l'irrigation sont la piste principale pour les stations de Montérégie mal reproduites. Ces pratiques demandent une autre source, par exemple la superficie drainée du Recensement de l'agriculture, à vérifier.

Test : la carte des classes doit se lire dans le champ appris. Le KGE médian des bassins de moins de 100 km², 0,526 le 2026-09-15, doit progresser sans dégrader les autres. Contrôle du masque : masquer des zones cartographiées ne doit pas changer la simulation plus que l'écart entre deux graines.
