...
Épreuves du 2026-09-16, sans simulation. Le croisement comptait mal l'aire des unités hydrologiques en plusieurs morceaux, d'où des couvertures jusqu'à 630 ; corrigé, elle plafonne à 1 dans toutes les régions. Ajouter les treize colonnes au champ d'un modèle entraîné déplace ses paramètres de 0,02 % en médiane, et de rien avec des poids nuls. Les nouveaux poids reçoivent un gradient. Sur 68 stations couvertes à plus de moitié, ajouter la part de till améliore un peu la prédiction du biais de volume hors échantillon. Le R² passe de 0,29 à 0,31, avec p de 0,04 par permutation. La composition complète n'apporte rien, et aucune n'explique le KGE. L'information est donc réelle mais modeste, et en partie confondue avec la région.
