...
**LE PARTAGE PLUIE/NEIGE EST TROP SEC, DÉMONTRÉ PAR BILAN DE MASSE** (2026-08-20, quatrième version du diagnostic, la première dont toutes les statistiques sont correctes de bout en bout). En fraction de la précipitation cumulée depuis le 1er novembre, au nœud de chaque site, médiane sur les sites :
