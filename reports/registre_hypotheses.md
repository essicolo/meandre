...
Le gain ne se distribue pas également, et c'est là son intérêt. Territoire par territoire, la texture divise par deux l'erreur là où le transfert naïf échoue, sur Montréal 0,051 contre 0,107, sur l'Outaouais 0,069 contre 0,092, au Saguenay 0,040 contre 0,070 ; elle coûte quelques millièmes là où la moyenne des autres territoires suffisait déjà, en Gaspésie 0,051 contre 0,043 et au Lac-Saint-Jean 0,049 contre 0,040. C'est le comportement attendu d'une covariable de régionalisation : elle sert quand la moyenne se trompe.
...
CORRECTION DU 2026-09-20, sur une comparaison illicite de ma part. La colonne « indice de base » de ce tableau est la part SOUTERRAINE DE LA PRODUCTION, et je l'ai comparée à l'indice mesuré par le filtre de Lyne et Hollick sur les hydrogrammes observés. Les deux ne sont pas la même grandeur : le filtre sépare le lent du rapide, pas les chemins de l'eau, et un écoulement hypodermique amorti par le versant et par le tronçon lui apparaît comme de la base. Passé le MÊME filtre sur les séries simulées aux mêmes stations, le classement s'inverse. Le témoin de l'Outaouais rend 0,695 contre 0,581 observé, soit un hydrogramme trop lisse de onze centièmes, et la pile rend 0,532, soit cinq centièmes trop nerveux : la pile est deux fois plus proche. Au Saint-Laurent nord-ouest c'est l'inverse, le témoin rend 0,569 contre 0,538 et la pile 0,415, trop lent de douze centièmes. Les constantes de temps de la pile ont été réglées sur l'Outaouais et ne transfèrent pas, ce qui est cohérent avec les huit centièmes de KGE qu'elle y coûte.

Le reste du partage tient. La pile s'approche mieux de tout le reste : la variation de l'écoulement de base, 0,61 contre 0,15 pour 0,68 mesuré, la nervosité de la composante rapide, et la troncature, réduite de 0,10 à 0,007. Le témoin produit donc beaucoup d'eau de base qui ne respire pas, ce qui est la signature d'un réservoir alimenté par une recharge plate.
