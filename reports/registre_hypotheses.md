...
| R11 | Le déficit hivernal vient d'un aquifère affamé : libérer la recharge le comblera | Libérée à la valeur mesurée (5e-5), la recharge EFFONDRE le modèle (0.4446, abandon à l'époque 4) : elle draine le sol au profit du réservoir. Le calibré (~1e-7) et le mesuré diffèrent d'un facteur 500 ; l'optimum est entre les deux, balayage à zéro époque en file | 08-17 |
