"""Prétraitement CaSR par QUANTILE MAPPING sur la distribution de quebec.zarr.
...
OUT = ".runs/slso/data/forcing-casr-qm.nc"
...
for n in range(N):
    ...
    Pqm[:, n] = np.interp(Pc[:, n], cs, zs)             # même rang -> valeur QZ
