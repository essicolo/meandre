...
(basin_hs_mini.duckdb), pour ne pas écraser le bassin qui marche.
...
BASIN_DB = RUN_DIR / "data" / "basin_hs_mini.duckdb"   # base SÉPARÉE
...
cache = build_basin(
    ...
    basin_db=BASIN_DB,
    min_area_km2=200.0,
    max_subcatchments=800,
    max_segment_area_km2=400.0,
    max_segment_length_km=200.0,
